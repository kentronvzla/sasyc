...
class CreateForeignTable extends Migration {
    ...
    public function down() {
        ...
        Schema::table('recaudos', function(Blueprint $table) {
            $table->dropForeign('recaudos_tipo_ayuda_id_foreign');
            $table->dropIndex('recaudos_tipo_ayuda_id_index');
        });

        Schema::table('memos', function(Blueprint $table) {
            $table->dropForeign('memos_usuario_id_foreign');
            $table->dropIndex('memos_usuario_id_index');
        });
    }
