                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="{{url('solicitar?estatus=EAA&solo_asignadas=true&usuario_asignacion_id='."$id")}}" class="btn btn-default btn-reset"><i class="glyphicon glyphicon-trash"></i> Cancelar</a>
                        </div>
                    </div>
                    {{Form::close()}}
